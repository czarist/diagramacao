  ...
  <div class="row">
    <div class="col-12">
      <div class="d-flex text-center align-items-center justify-content-center">
        <h6 class="border SourceSerifPro-Light border-dark pt-2 pb-2 pr-4 pl-4">
          FABY HOFF
        </h6>
      </div>
    </div>
    <div class="col-12 mt-5">
      <div class="row">
        ...
        <div class="col-xl-2 col-12 d-flex d-xl-block justify-content-center align-items-center">
          <img class="m-xl-0 m-5" src="libraries/img/faby.png" alt="marcelo" width="110" height="130">
        </div>
        <div class="col-xl-8 col-12">
          <p class="text-xl-left text-center text-muted">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce egestas mollis dui, sed euismod metus varius at. Integer vestibulum, arcu at vestibulum molestie, tortor nisi vehicula orci, nec ullamcorper enim nulla vel sem. Nullam consectetur augue ac felis rutrum ullamcorper. Donec luctus eleifend est, non ullamcorper est mattis ac. In efficitur purus vitae placerat aliquet. In hac habitasse platea dictumst. Sed fringilla sapien massa, at cursus nulla dignissim nec.
          </p>
        </div>
        <div class="col-xl-1"></div>
      </div>
    ...
    <div class="col-1"></div>
    <div class="col-xl-10 col-12 border-bottom border-dark">
      <p class="w-100 text-dark text-right">
        <a class="text-dark" href="#">LEIA OUTROS CONTEÚDOS DA <b>FABY HOFF [+]</b></a>
      </p>
    </div>
    <div class="col-1"></div>
    <div class="col-12 mt-5 mb-5"></div>
    <div class="col-1 col-xl-2 mt-5"></div>
