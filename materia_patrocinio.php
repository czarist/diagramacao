...
<section id="patrocinador" class="container mt-5">
  <div class="row text-publicidade">
    <div class="col-xl-2 col-1"></div>
    <div class="col-xl-8 col-10 border border-dark p-3">
      <div class="row">
        <div class="col-xl-8 col-12 text-xl-right text-left">
          <span class="text-muted">PUBLIEDITORIAL</span>
          <p class="m-0">
            CONTEÚDO PRODUZIDO ESPECIALMENTE PARA VOCÊ
          </p>
          <p class="m-0">
            COM O APOIO E PATROCÍNIO DE
          </p>
        </div>
        <div class="col-xl-4 col-12">
          <a href="#">
            <img class="mw-100" width="200" height="70" src="libraries/img/hr.jpeg" alt="patrocinador">
          </a>
        </div>
      </div>
    </div>
